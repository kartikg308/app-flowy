...
import 'inline_math_equation/inline_math_equation.dart';
...
final Map<String, BlockComponentBuilder> standardBlockComponentBuilderMap = {
  ...
  InlineMathEquationKeys.type: InlineMathEquationComponentBuilder(
    configuration: standardBlockComponentConfiguration.copyWith(
      placeholderText: (node) => 'Equation ${node.attributes[HeadingBlockKeys.level]}',
    ),
  ),
