...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    ...
    _jsonString = PlatformExtension.isDesktopOrWeb ? rootBundle.loadString('assets/example.json') : rootBundle.loadString('assets/mobile_example.json');

    _widgetBuilder = (context) => Editor(
          jsonString: _jsonString,
          onEditorStateChange: (editorState) {
            _editorState = editorState;
            print("editor state selection is : ${editorState.document.toJson()}");
            print("current cursor position is ${editorState}");
          },
        );
  }
